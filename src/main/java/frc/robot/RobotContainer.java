...
public RobotContainer() {
  ...
  NamedCommands.registerCommand("OpenSide1PieceSetpoint", new ParallelDeadlineGroup(new WaitCommand(1.00), new PIDAngleControl(m_AngleController, m_LEDs, () -> {return 0.6898;})));
